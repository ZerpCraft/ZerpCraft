...
public class SetPurchasingPermission implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (sender.isOp()) {
            ...
            System.out.println("ispurchasing is currently " + zcPlayer.getIsPurchasing());
            zcPlayer.setIsPurchasing(Boolean.parseBoolean(args[1]));
